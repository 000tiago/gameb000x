    const personagens = [
        { nome: "Ares", forca: 9, imagem: "imagem/img (1).png" },
        { nome: "Athena", forca: 8, imagem: "imagem/img (2).png" },
        { nome: "Hércules", forca: 10, imagem: "imagem/img (3).png" },
        { nome: "Perseu", forca: 7, imagem: "imagem/img (4).png" },
        { nome: "Medusa", forca: 6, imagem: "imagem/img (5).png" },
        { nome: "Hades", forca: 9, imagem: "imagem/img (6).png" },
        { nome: "Apolo", forca: 7, imagem: "imagem/img (7).png" },
        { nome: "Artemis", forca: 8, imagem: "imagem/img (8).png" },
        { nome: "Poseidon", forca: 10, imagem: "imagem/img (9).png" },
        { nome: "Zeus", forca: 10, imagem: "imagem/img (10).png" }
    ];
